...
//  GuessTheFlag
//
//  Created by Alessandre Livramento on 25/09/22.
//
...
struct ContentView: View {
    ...
    @State private var showingQuetion = false
    ...
    var body: some View {
        ZStack {
            ...
            .padding()
            .alert("The End", isPresented: $showingQuetion){
                Button("Restart the game", action: reset)
            } message: {
                Text("End of the game! Your score is \(countScore)")
            }
        }
...
struct BigBluFont: ViewModifier {
